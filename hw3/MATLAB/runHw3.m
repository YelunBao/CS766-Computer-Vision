...
signAcademicHonestyPolicy('Yelun Bao', 'ybao35');
...
% -------------------
portrait_pts = [0   0; 327   0; 326  400; 0  400];
bg_pts = [100   16; 276   70; 284  423; 84  438];
...
% stitch three images
imgl = im2single(imread('LN_left.jpg'));
imgr = im2single(imread('LN_right.jpg'));
...
%figure, imshow(stitched_img);
imwrite(stitched_img, 'LN_panorama.png');
